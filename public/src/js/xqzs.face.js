...
xqzs.face = {
    ...
    init: function () {
        ...
        var _fh_ = 1.68;
        var _smallfh_ = 1.1;
        var style = 'a.exp{display:inline-block;vertical-align:middle;vertical-align:text-bottom;height:' + _fh_ + 'rem;width:' + _fh_ + 'rem;margin: 0 auto;background-image:url("' + web.IMG_PATH + 'exp.png?v=2");background-size:' + _fh_ + 'rem;}';

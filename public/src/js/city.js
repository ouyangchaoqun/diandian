...
/******/ ([
    ...
    function(module, exports, __webpack_require__) {
        ...
        if(localCity){
            localCity.addEventListener('click', function () {

                var that = this;
                //异步操作开始

                $.get(web.JS_PATH+'/city.json',function(data){
                    _weui2.default.picker(data, {
                        depth: 3,
        ...
        var hourAndminute = document.querySelector('#hour_minute');
        if(hourAndminute){
            hourAndminute.addEventListener('click', function () {
                var that = this;
                //封装一个生成数组的方法开始
                function getArray(endNum){
                    var arr = [];
                ...
                _weui2.default.picker(getArray(24),getArray(60), {
                    defaultValue: ['00', '00'],
                    onChange: function onChange(result) {
                        console.log(result);
                    },
                    onConfirm: function onConfirm(result) {
                        ...
                        that.innerHTML = result[0].value +':'+ result[1].value;

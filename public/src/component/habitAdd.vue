...
<style>
    ...
    .habit_add_box .my_habit .item .txt{color:#333}
    ...
    .habit_add_box .my_habit .title{ font-size: 0.88235rem; padding-left: 0.6rem; padding-top: 0.4rem; padding-bottom: 0.4rem;}
